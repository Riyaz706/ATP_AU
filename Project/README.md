...
For focused technical details, setup steps, schemas, and routes, check the dedicated project README files:

- **[Blog Frontend Client Documentation (README-frontend.md)](file:///Users/mdriyaz/.gemini/antigravity/scratch/ATP_AU/Project/README-frontend.md)**
- **[Blog Backend API Documentation (README-backend.md)](file:///Users/mdriyaz/.gemini/antigravity/scratch/ATP_AU/Project/README-backend.md)**
